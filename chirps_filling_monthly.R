...
# Description: This script is for gap filling precipitation data with CHIRPS 

library(raster)
require(ncdf4)

#Load data from CHIRPS in netCDF format
